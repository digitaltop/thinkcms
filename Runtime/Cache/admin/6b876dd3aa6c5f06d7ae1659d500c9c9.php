...
//    }
       ...
       <?php if(checkSecurity($_SESSION['USER_ID'], 'Model', 'oneKeyToMeRole') == true || $_SESSION['USER_ID']== '1'): ?><a href="#" onClick="javascript:oneKeyToMeRole();" class="easyui-linkbutton" iconcls="icon-tabicons387" plain="true" style="float:left;">一键授权给自己</a><div class="datagrid-btn-separator"></div><?php endif; ?>
