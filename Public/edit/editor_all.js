 ...
 *子标题
 */
UE.commands['subtitle'] = {
    execCommand : function(){
        $.messager.prompt('请输入','请输入子标题名称：',function(subtitleInput){
            if(subtitleInput){
                editor.execCommand('subtitle', subtitleInput.value);
                parent.document.getElementById('paginationtype').value=2;
            }
        });
    }
};
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'blockquote', 'pasteplain', 'pagebreak','subtitle',
