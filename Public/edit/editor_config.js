...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,
        catcherPath:attrPath                  //图片修正地址，同imagePath
        ...
        'insertimage', 'emotion','scrawl', 'insertvideo','music','attachment', 'map', 'gmap', 'insertframe','highlightcode','webapp','pagebreak','subtitle','template','background', '|',
        ...
        ,
        iframeUrlMap:{
            'subtitle':URL + 'dialogs/subtitle/subtitle.html'
        }
